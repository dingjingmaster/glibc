...
#    endif
long int __internal_syscall_cancel (__syscall_arg_t                           a1,
                                    __syscall_arg_t                           a2,
                                    __syscall_arg_t                           a3,
                                    __syscall_arg_t                           a4,
                                    __syscall_arg_t                           a5,
                                    __syscall_arg_t                           a6,
                                    __SYSCALL_CANCEL7_ARG_DEF __syscall_arg_t nr) attribute_hidden;

long int __syscall_cancel (__syscall_arg_t                           arg1,
...
#    define __SYSCALL_CANCEL1(name, a1) \
        __syscall_cancel (__SSC (a1), 0, 0, 0, 0, 0, __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __SYSCALL_CANCEL2(name, a1, a2) \
        __syscall_cancel (__SSC (a1), __SSC (a2), 0, 0, 0, 0, __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __SYSCALL_CANCEL3(name, a1, a2, a3)                        \
        __syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), 0, 0, 0, \
                          __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __SYSCALL_CANCEL4(name, a1, a2, a3, a4)                             \
        __syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), 0, 0, \
                          __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __SYSCALL_CANCEL5(name, a1, a2, a3, a4, a5)                                  \
        __syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), __SSC (a5), 0, \
                          __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __SYSCALL_CANCEL6(name, a1, a2, a3, a4, a5, a6)                                       \
        __syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), __SSC (a5), __SSC (a6), \
                          __SYSCALL_CANCEL7_ARG __NR_##name)
...
#    define __INTERNAL_SYSCALL_CANCEL0(name) \
        __internal_syscall_cancel (0, 0, 0, 0, 0, 0, __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __INTERNAL_SYSCALL_CANCEL1(name, a1) \
        __internal_syscall_cancel (__SSC (a1), 0, 0, 0, 0, 0, __SYSCALL_CANCEL7_ARG __NR_##name)
...
#    define __INTERNAL_SYSCALL_CANCEL3(name, a1, a2, a3)                        \
        __internal_syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), 0, 0, 0, \
                                   __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __INTERNAL_SYSCALL_CANCEL4(name, a1, a2, a3, a4)                             \
        __internal_syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), 0, 0, \
                                   __SYSCALL_CANCEL_NARGS __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __INTERNAL_SYSCALL_CANCEL5(name, a1, a2, a3, a4, a5)                                  \
        __internal_syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), __SSC (a5), 0, \
                                   __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __INTERNAL_SYSCALL_CANCEL6(name, a1, a2, a3, a4, a5, a6)                           \
        __internal_syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), __SSC (a5), \
                                   __SSC (a6), __SYSCALL_CANCEL7_ARG __NR_##name)
#    define __INTERNAL_SYSCALL_CANCEL7(name, a1, a2, a3, a4, a5, a6, a7)                       \
        __internal_syscall_cancel (__SSC (a1), __SSC (a2), __SSC (a3), __SSC (a4), __SSC (a5), \
                                   __SSC (a6), __SSC (a7), __NR_##name)
...
#    else
#        define INTERNAL_SYSCALL_CANCEL(...) __INTERNAL_SYSCALL_CANCEL_CALL (__VA_ARGS__)
