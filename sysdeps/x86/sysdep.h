...
#    define STATE_SAVE_MASK                                                                   \
        ((1 << X86_XSTATE_SSE_ID) | (1 << X86_XSTATE_AVX_ID) | (1 << X86_XSTATE_BNDREGS_ID) | \
         (1 << X86_XSTATE_K_ID) | (1 << X86_XSTATE_ZMM_H_ID) | (1 << X86_XSTATE_ZMM_ID) |     \
         (1 << X86_XSTATE_APX_F_ID))

/* AMX state mask.  */
#    define AMX_STATE_SAVE_MASK ((1 << X86_XSTATE_TILECFG_ID) | (1 << X86_XSTATE_TILEDATA_ID))
...
#    define STATE_SAVE_MASK                                                                   \
        ((1 << X86_XSTATE_SSE_ID) | (1 << X86_XSTATE_AVX_ID) | (1 << X86_XSTATE_BNDREGS_ID) | \
         (1 << X86_XSTATE_K_ID) | (1 << X86_XSTATE_ZMM_H_ID))
...
/* States which should be saved for TLSDESC_CALL and TLS_DESC_CALL.
   ...
   RAX/EAX.  */
#define TLSDESC_CALL_STATE_SAVE_MASK (FULL_STATE_SAVE_MASK | (1 << X86_XSTATE_X87_ID))
